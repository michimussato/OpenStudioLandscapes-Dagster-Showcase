...
# Asset Selections
# asset_selection_get_temp_dir = AssetSelection.assets("temp_dir")
...
# job_get_temp_dir = define_asset_job(
#     name="job_get_temp_dir",
#     selection=asset_selection_get_temp_dir,
# )
